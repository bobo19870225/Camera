...
public class CollageTwelve extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwelve$3 */
    class C07193 implements Runnable {
        C07193() {
        }

        public void run() {
            CollageTwelve.this.setGridPadding(CollageTwelve.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwelve$4 */
    class C07204 extends SimpleOnGestureListener {
        C07204() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageTwelve.this.mPopupWindow != null) {
                if (CollageTwelve.this.mPopupWindow.isShowing()) {
                    CollageTwelve.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageTwelve.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageTwelve.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwelve$5 */
    class C07215 implements OnClickListener {
        C07215() {
        }

        public void onClick(View view) {
            CollageTwelve.this.mPopupWindow.dismiss();
            CollageTwelve.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwelve$6 */
    class C07226 implements OnClickListener {
        C07226() {
        }

        public void onClick(View view) {
            CollageTwelve.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageTwelve.this.getStoredBitmap(CollageTwelve.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageTwelve.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageTwelve.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwelve$7 */
    class C07237 implements OnClickListener {
        C07237() {
        }
    ...
    public static CollageTwelve newInstance(boolean b) {
        CollageTwelve fragment = new CollageTwelve();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_12, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageTwelve.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwelve$2$1 */
                class C07171 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageTwelve.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageTwelve.this.getActivity().runOnUiThread(new C07171());
                    }
                }
            });
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C07204());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C07215());
        delete.setOnClickListener(new C07226());
        cancel.setOnClickListener(new C07237());
    }
