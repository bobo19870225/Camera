...
public class CollageFourtyEight extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyEight$3 */
    class C04873 implements Runnable {
        C04873() {
        }

        public void run() {
            CollageFourtyEight.this.setGridPadding(CollageFourtyEight.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyEight$4 */
    class C04884 extends SimpleOnGestureListener {
        C04884() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageFourtyEight.this.mPopupWindow != null) {
                if (CollageFourtyEight.this.mPopupWindow.isShowing()) {
                    CollageFourtyEight.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageFourtyEight.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageFourtyEight.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyEight$5 */
    class C04895 implements OnClickListener {
        C04895() {
        }

        public void onClick(View view) {
            CollageFourtyEight.this.mPopupWindow.dismiss();
            CollageFourtyEight.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyEight$6 */
    class C04906 implements OnClickListener {
        C04906() {
        }

        public void onClick(View view) {
            CollageFourtyEight.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageFourtyEight.this.getStoredBitmap(CollageFourtyEight.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageFourtyEight.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageFourtyEight.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyEight$7 */
    class C04917 implements OnClickListener {
        C04917() {
        }
    ...
    public static CollageFourtyEight newInstance(boolean b) {
        CollageFourtyEight fragment = new CollageFourtyEight();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_48, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageFourtyEight.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyEight$2$1 */
                class C04851 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageFourtyEight.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageFourtyEight.this.getActivity().runOnUiThread(new C04851());
                    }
                }
            });
    ...
    private void optimizeLayout(View view) {
        ...
        ImageUtils.optimizeView(this.rl4, 0.0f, 0.0f, Dimensions.S_3P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl5, (float) Dimensions.S_3P, 0.0f, Dimensions.S_3P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl6, (float) (Dimensions.S_3P * 2), 0.0f, Dimensions.S_3P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl7, 0.0f, 0.0f, Dimensions.S_3P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl8, (float) Dimensions.S_3P, 0.0f, Dimensions.S_3P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl9, (float) (Dimensions.S_3P * 2), 0.0f, Dimensions.S_3P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl10, 0.0f, 0.0f, Dimensions.S_3P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl11, (float) Dimensions.S_3P, 0.0f, Dimensions.S_3P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl12, (float) (Dimensions.S_3P * 2), 0.0f, Dimensions.S_3P, Dimensions.MATCH_PARENT);
        view.post(new C04873());
    }
    ...
    public void setGridPadding(int padding) {
        ...
        lp4.setMargins(this.curPadding, this.curPadding / 2, this.curPadding / 2, this.curPadding / 2);
        ...
        lp9.setMargins(this.curPadding / 2, this.curPadding / 2, this.curPadding, this.curPadding);
        ...
        this.div4.setX((this.rl5.getX() + ((float) this.rl5.getWidth())) - ((float) (this.curPadding / 2)));
        this.div5.setX((float) (this.rl7.getWidth() - (this.curPadding / 2)));
        this.div6.setX((this.rl8.getX() + ((float) this.rl8.getWidth())) - ((float) (this.curPadding / 2)));
        this.div7.setX((float) (this.rl10.getWidth() - (this.curPadding / 2)));
        this.div8.setX((this.rl11.getX() + ((float) this.rl11.getWidth())) - ((float) (this.curPadding / 2)));
    }
        ...
        switch (motionEvent.getAction()) {
            ...
            case 2:
                ...
                if (view.getId() == R.id.div1 && (view.getY() - ((float) dy)) + ((float) view.getHeight()) <= this.div2.getY() + ((float) this.div2.getHeight()) && view.getY() - ((float) dy) >= 0.0f) {
                    ...
                    view.requestLayout();
                    view.postInvalidate();
                } else if (view.getId() == R.id.div2 && (view.getY() - ((float) dy)) + ((float) view.getHeight()) <= this.rl3.getY() + ((float) this.rl3.getHeight()) && view.getY() - ((float) dy) >= this.div1.getY()) {
                    this.rl2.getLayoutParams().height -= dy;
                    if (this.rl2.getLayoutParams().height >= 0) {
                        this.rl2.setVisibility(View.VISIBLE);
                    } else {
                    ...
                    view.requestLayout();
                    view.postInvalidate();
                } else if (view.getId() == R.id.div3 && (view.getX() - ((float) dx)) + ((float) view.getWidth()) <= this.div4.getX() + ((float) this.div4.getWidth()) && view.getX() - ((float) dx) >= 0.0f) {
                ...
                } else if (view.getId() == R.id.div4 && (view.getX() - ((float) dx)) + ((float) view.getWidth()) <= this.rl6.getX() + ((float) this.rl6.getWidth()) && view.getX() - ((float) dx) >= this.div3.getX()) {
                    this.rl5.getLayoutParams().width -= dx;
                    if (this.rl5.getLayoutParams().width >= 0) {
                        this.rl5.setVisibility(View.VISIBLE);
                    } else {
                    ...
                    view.requestLayout();
                    view.postInvalidate();
                } else if (view.getId() == R.id.div5 && (view.getX() - ((float) dx)) + ((float) view.getWidth()) <= this.div6.getX() + ((float) this.div6.getWidth()) && view.getX() - ((float) dx) >= 0.0f) {
                    ...
                    view.setX(view.getX() - ((float) dx));
                } else if (view.getId() == R.id.div6 && (view.getX() - ((float) dx)) + ((float) view.getWidth()) <= this.rl9.getX() + ((float) this.rl9.getWidth()) && view.getX() - ((float) dx) >= this.div5.getX()) {
                    this.rl8.getLayoutParams().width -= dx;
                    if (this.rl8.getLayoutParams().width >= 0) {
                        this.rl8.setVisibility(View.VISIBLE);
                    } else {
                    ...
                    this.rl9.setX(this.rl9.getX() - ((float) dx));
                    view.setX(view.getX() - ((float) dx));
                    view.requestLayout();
                    view.postInvalidate();
                }
                if (view.getId() != R.id.div7 || (view.getX() - ((float) dx)) + ((float) view.getWidth()) > this.div8.getX() + ((float) this.div8.getWidth()) || view.getX() - ((float) dx) < 0.0f) {
                    if (view.getId() == R.id.div8 && (view.getX() - ((float) dx)) + ((float) view.getWidth()) <= this.rl12.getX() + ((float) this.rl12.getWidth()) && view.getX() - ((float) dx) >= this.div7.getX()) {
                ...
                Log.i("movetest", "rl1 : " + this.rl1.getLayoutParams().width + "  rl2 : " + this.rl2.getLayoutParams().width);
                this.rl11.setX(this.rl11.getX() - ((float) dx));
                view.setX(view.getX() - ((float) dx));
                break;
        }
        return true;
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C04884());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C04895());
        delete.setOnClickListener(new C04906());
        cancel.setOnClickListener(new C04917());
    }
