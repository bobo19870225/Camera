...
public class CollageThirteen extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirteen$3 */
    class C06233 implements Runnable {
        C06233() {
        }

        public void run() {
            CollageThirteen.this.setGridPadding(CollageThirteen.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirteen$4 */
    class C06244 extends SimpleOnGestureListener {
        C06244() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageThirteen.this.mPopupWindow != null) {
                if (CollageThirteen.this.mPopupWindow.isShowing()) {
                    CollageThirteen.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageThirteen.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageThirteen.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirteen$5 */
    class C06255 implements OnClickListener {
        C06255() {
        }

        public void onClick(View view) {
            CollageThirteen.this.mPopupWindow.dismiss();
            CollageThirteen.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirteen$6 */
    class C06266 implements OnClickListener {
        C06266() {
        }

        public void onClick(View view) {
            CollageThirteen.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageThirteen.this.getStoredBitmap(CollageThirteen.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageThirteen.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageThirteen.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirteen$7 */
    class C06277 implements OnClickListener {
        C06277() {
        }
    ...
    public static CollageThirteen newInstance(boolean b) {
        CollageThirteen fragment = new CollageThirteen();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_13, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageThirteen.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirteen$2$1 */
                class C06211 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageThirteen.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageThirteen.this.getActivity().runOnUiThread(new C06211());
                    }
                }
            });
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C06244());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C06255());
        delete.setOnClickListener(new C06266());
        cancel.setOnClickListener(new C06277());
    }
