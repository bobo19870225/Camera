...
public class CollageThirtyTwo extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtyTwo$3 */
    class C07033 implements Runnable {
        C07033() {
        }

        public void run() {
            CollageThirtyTwo.this.setGridPadding(CollageThirtyTwo.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtyTwo$4 */
    class C07044 extends SimpleOnGestureListener {
        C07044() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageThirtyTwo.this.mPopupWindow != null) {
                if (CollageThirtyTwo.this.mPopupWindow.isShowing()) {
                    CollageThirtyTwo.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageThirtyTwo.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageThirtyTwo.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtyTwo$5 */
    class C07055 implements OnClickListener {
        ...
        public void onClick(View view) {
            CollageThirtyTwo.this.mPopupWindow.dismiss();
            CollageThirtyTwo.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtyTwo$6 */
    class C07066 implements OnClickListener {
        ...
        public void onClick(View view) {
            CollageThirtyTwo.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageThirtyTwo.this.getStoredBitmap(CollageThirtyTwo.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageThirtyTwo.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageThirtyTwo.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtyTwo$7 */
    class C07077 implements OnClickListener {
        C07077() {
        }
    ...
    public static CollageThirtyTwo newInstance(boolean b) {
        CollageThirtyTwo fragment = new CollageThirtyTwo();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_32, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageThirtyTwo.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtyTwo$2$1 */
                class C07011 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageThirtyTwo.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageThirtyTwo.this.getActivity().runOnUiThread(new C07011());
                    }
                }
            });
    ...
    public void setGridPadding(int padding) {
        ...
        lp3.setMargins(this.curPadding / 2, this.curPadding / 2, this.curPadding / 2, this.curPadding / 2);
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C07044());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C07055());
        delete.setOnClickListener(new C07066());
        cancel.setOnClickListener(new C07077());
    }
