...
public class ShareImageActivity extends Activity implements OnClickListener {
    ...
    class C03792 implements OnDismissListener {
        C03792() {
        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_share:
                ...
                ringProgressDialog.setOnDismissListener(new C03792());
                return;
            case R.id.btn_rate:
                ...
                alertDialog.setButton(getResources().getString(R.string.yes1), new C03803());
                alertDialog.setButton2(getResources().getString(R.string.no1), new C03834());
                alertDialog.show();
                return;
            case R.id.btn_more:
                Intent i = new Intent("android.intent.action.VIEW");
    ...
    private void saveBitmapWithoutWatermark() {
