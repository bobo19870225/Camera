...
public class CollageFour extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFour$3 */
    class C04633 implements Runnable {
        C04633() {
        }

        public void run() {
            CollageFour.this.setGridPadding(CollageFour.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFour$4 */
    class C04644 extends SimpleOnGestureListener {
        C04644() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageFour.this.mPopupWindow != null) {
                if (CollageFour.this.mPopupWindow.isShowing()) {
                    CollageFour.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageFour.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageFour.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFour$5 */
    class C04655 implements OnClickListener {
        C04655() {
        }

        public void onClick(View view) {
            CollageFour.this.mPopupWindow.dismiss();
            CollageFour.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFour$6 */
    class C04666 implements OnClickListener {
        C04666() {
        }

        public void onClick(View view) {
            CollageFour.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageFour.this.getStoredBitmap(CollageFour.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageFour.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageFour.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFour$7 */
    class C04677 implements OnClickListener {
        C04677() {
        }
    ...
    public static CollageFour newInstance(boolean b) {
        CollageFour fragment = new CollageFour();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_4, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageFour.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFour$2$1 */
                class C04611 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageFour.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageFour.this.getActivity().runOnUiThread(new C04611());
                    }
                }
            });
    ...
    public void setGridPadding(int padding) {
        ...
        lp3.setMargins(this.curPadding / 2, this.curPadding, this.curPadding, this.curPadding);
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C04644());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C04655());
        delete.setOnClickListener(new C04666());
        cancel.setOnClickListener(new C04677());
    }
