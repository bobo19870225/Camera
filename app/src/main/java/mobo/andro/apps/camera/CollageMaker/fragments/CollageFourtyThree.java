...
public class CollageFourtyThree extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyThree$3 */
    class C05433 implements Runnable {
        C05433() {
        }

        public void run() {
            CollageFourtyThree.this.setGridPadding(CollageFourtyThree.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyThree$4 */
    class C05444 extends SimpleOnGestureListener {
        C05444() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageFourtyThree.this.mPopupWindow != null) {
                if (CollageFourtyThree.this.mPopupWindow.isShowing()) {
                    CollageFourtyThree.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageFourtyThree.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageFourtyThree.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyThree$5 */
    class C05455 implements OnClickListener {
        ...
        public void onClick(View view) {
            CollageFourtyThree.this.mPopupWindow.dismiss();
            CollageFourtyThree.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyThree$6 */
    class C05466 implements OnClickListener {
        ...
        public void onClick(View view) {
            CollageFourtyThree.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageFourtyThree.this.getStoredBitmap(CollageFourtyThree.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageFourtyThree.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageFourtyThree.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyThree$7 */
    ...
    public static CollageFourtyThree newInstance(boolean b) {
        CollageFourtyThree fragment = new CollageFourtyThree();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_43, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageFourtyThree.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyThree$2$1 */
                class C05411 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageFourtyThree.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageFourtyThree.this.getActivity().runOnUiThread(new C05411());
                    }
                }
            });
    ...
    private void optimizeLayout(View view) {
        ...
        main_rel.invalidate();
        ImageUtils.optimizeView(this.rl1, 0.0f, 0.0f, Dimensions.MATCH_PARENT, Dimensions.S_4P);
        ImageUtils.optimizeView(this.rl2, 0.0f, (float) Dimensions.S_4P, Dimensions.MATCH_PARENT, Dimensions.S_4P);
        ImageUtils.optimizeView(this.rl3, 0.0f, (float) (Dimensions.S_4P * 2), Dimensions.MATCH_PARENT, Dimensions.S_4P);
        ImageUtils.optimizeView(this.rl4, 0.0f, (float) (Dimensions.S_4P * 3), Dimensions.MATCH_PARENT, Dimensions.S_4P);
        ImageUtils.optimizeView(this.rl5, 0.0f, 0.0f, Dimensions.S_2P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl6, (float) Dimensions.S_2P, 0.0f, Dimensions.S_2P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl7, 0.0f, 0.0f, Dimensions.S_2P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl8, (float) Dimensions.S_2P, 0.0f, Dimensions.S_2P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl9, 0.0f, 0.0f, Dimensions.S_2P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl10, (float) Dimensions.S_2P, 0.0f, Dimensions.S_2P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl11, 0.0f, 0.0f, Dimensions.S_2P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl12, (float) Dimensions.S_2P, 0.0f, Dimensions.S_2P, Dimensions.MATCH_PARENT);
        view.post(new C05433());
    }
    ...
    public void setGridPadding(int padding) {
        ...
        lp8.setMargins(this.curPadding / 2, this.curPadding / 2, this.curPadding, this.curPadding);
        ...
        this.div3.setY((this.rl3.getY() + ((float) this.rl3.getHeight())) - ((float) (this.curPadding / 2)));
        this.div4.setX((float) (this.rl5.getWidth() - (this.curPadding / 2)));
        this.div5.setX((float) (this.rl7.getWidth() - (this.curPadding / 2)));
        ...
        switch (motionEvent.getAction()) {
            ...
            case 2:
                ...
                if (view.getId() != R.id.div1 || (view.getY() - ((float) dy)) + ((float) view.getHeight()) > this.div2.getY() + ((float) this.div2.getHeight()) || view.getY() - ((float) dy) < 0.0f) {
                    if (view.getId() != R.id.div2 || (view.getY() - ((float) dy)) + ((float) view.getHeight()) > this.div3.getY() + ((float) this.div3.getHeight()) || view.getY() - ((float) dy) < this.div1.getY()) {
                        if (view.getId() != R.id.div3 || (view.getY() - ((float) dy)) + ((float) view.getHeight()) > this.rl4.getY() + ((float) this.rl4.getHeight()) || view.getY() - ((float) dy) < this.div2.getY()) {
                            if (view.getId() != R.id.div4 || (view.getX() - ((float) dx)) + ((float) view.getWidth()) > this.rl6.getX() + ((float) this.rl6.getWidth()) || view.getX() - ((float) dx) < 0.0f) {
                                if (view.getId() != R.id.div5 || (view.getX() - ((float) dx)) + ((float) view.getWidth()) > this.rl8.getX() + ((float) this.rl8.getWidth()) || view.getX() - ((float) dx) < 0.0f) {
                                ...
                                this.rl8.requestLayout();
                                this.rl8.postInvalidate();
                                view.setX(view.getX() - ((float) dx));
                                view.requestLayout();
                                view.postInvalidate();
                                break;
                            ...
                            this.rl6.requestLayout();
                            this.rl6.postInvalidate();
                            view.setX(view.getX() - ((float) dx));
                            view.requestLayout();
                            view.postInvalidate();
                            break;
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C05444());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C05455());
        delete.setOnClickListener(new C05466());
        cancel.setOnClickListener(new C05477());
    }
