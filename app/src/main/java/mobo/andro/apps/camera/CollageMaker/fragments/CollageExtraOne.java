...
public class CollageExtraOne extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageExtraOne$3 */
    class C04233 implements Runnable {
        C04233() {
        }

        public void run() {
            CollageExtraOne.this.setGridPadding(CollageExtraOne.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageExtraOne$4 */
    class C04244 extends SimpleOnGestureListener {
        C04244() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageExtraOne.this.mPopupWindow != null) {
                if (CollageExtraOne.this.mPopupWindow.isShowing()) {
                    CollageExtraOne.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageExtraOne.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageExtraOne.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageExtraOne$5 */
    class C04255 implements OnClickListener {
        C04255() {
        }

        public void onClick(View view) {
            CollageExtraOne.this.mPopupWindow.dismiss();
            CollageExtraOne.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageExtraOne$6 */
    class C04266 implements OnClickListener {
        C04266() {
        }

        public void onClick(View view) {
            CollageExtraOne.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageExtraOne.this.getStoredBitmap(CollageExtraOne.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageExtraOne.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageExtraOne.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageExtraOne$7 */
    class C04277 implements OnClickListener {
        C04277() {
        }
    ...
    public static CollageExtraOne newInstance(boolean b) {
        CollageExtraOne fragment = new CollageExtraOne();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_e1, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageExtraOne.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageExtraOne$2$1 */
                class C04211 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageExtraOne.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageExtraOne.this.getActivity().runOnUiThread(new C04211());
                    }
                }
            });
    ...
    public void setGridPadding(int padding) {
        ...
        lp6.setMargins(this.curPadding / 2, this.curPadding, this.curPadding, this.curPadding / 2);
        ...
        this.div6.setY((this.rl9.getY() + ((float) this.rl9.getHeight())) - ((float) (this.curPadding / 2)));
    }
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C04244());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C04255());
        delete.setOnClickListener(new C04266());
        cancel.setOnClickListener(new C04277());
    }
