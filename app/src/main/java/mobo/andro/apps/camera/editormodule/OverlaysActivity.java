...
public class OverlaysActivity extends Activity {
    ...
    class ThumbnailLoader extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            this.bb = Bitmap.createScaledBitmap(OverlaysActivity.this.bitmap, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
        }

        protected Void doInBackground(Void... params) {
            this.ol1 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o1);
            this.ol1 = Bitmap.createScaledBitmap(this.ol1, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol2 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o2);
            this.ol2 = Bitmap.createScaledBitmap(this.ol2, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol3 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o3);
            this.ol3 = Bitmap.createScaledBitmap(this.ol3, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol4 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o4);
            this.ol4 = Bitmap.createScaledBitmap(this.ol4, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol5 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o5);
            this.ol5 = Bitmap.createScaledBitmap(this.ol5, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol6 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o6);
            this.ol6 = Bitmap.createScaledBitmap(this.ol6, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol7 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o7);
            this.ol7 = Bitmap.createScaledBitmap(this.ol7, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol8 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o8);
            this.ol8 = Bitmap.createScaledBitmap(this.ol8, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol9 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o9);
            this.ol9 = Bitmap.createScaledBitmap(this.ol9, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol10 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o10);
            this.ol10 = Bitmap.createScaledBitmap(this.ol10, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol11 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o11);
            this.ol11 = Bitmap.createScaledBitmap(this.ol11, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol12 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o12);
            this.ol12 = Bitmap.createScaledBitmap(this.ol12, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol13 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o13);
            this.ol13 = Bitmap.createScaledBitmap(this.ol13, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol14 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o14);
            this.ol14 = Bitmap.createScaledBitmap(this.ol14, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol15 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o15);
            this.ol15 = Bitmap.createScaledBitmap(this.ol15, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol16 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o16);
            this.ol16 = Bitmap.createScaledBitmap(this.ol16, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol17 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o17);
            this.ol17 = Bitmap.createScaledBitmap(this.ol17, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol18 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o18);
            this.ol18 = Bitmap.createScaledBitmap(this.ol18, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol19 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o19);
            this.ol19 = Bitmap.createScaledBitmap(this.ol19, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol20 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o20);
            this.ol20 = Bitmap.createScaledBitmap(this.ol20, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol21 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o21);
            this.ol21 = Bitmap.createScaledBitmap(this.ol21, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol22 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o22);
            this.ol22 = Bitmap.createScaledBitmap(this.ol22, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol23 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o23);
            this.ol23 = Bitmap.createScaledBitmap(this.ol23, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol24 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o24);
            this.ol24 = Bitmap.createScaledBitmap(this.ol24, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol25 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o25);
            this.ol25 = Bitmap.createScaledBitmap(this.ol25, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol26 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o26);
            this.ol26 = Bitmap.createScaledBitmap(this.ol26, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol27 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o27);
            this.ol27 = Bitmap.createScaledBitmap(this.ol27, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol28 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o28);
            this.ol28 = Bitmap.createScaledBitmap(this.ol28, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol29 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o29);
            this.ol29 = Bitmap.createScaledBitmap(this.ol29, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
            this.ol30 = BitmapFactory.decodeResource(OverlaysActivity.this.getResources(), R.drawable.editor_o30);
            this.ol30 = Bitmap.createScaledBitmap(this.ol30, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
