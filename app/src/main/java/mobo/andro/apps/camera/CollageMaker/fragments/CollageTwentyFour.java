...
public class CollageTwentyFour extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyFour$3 */
    class C07513 implements Runnable {
        C07513() {
        }

        public void run() {
            CollageTwentyFour.this.setGridPadding(CollageTwentyFour.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyFour$4 */
    class C07524 extends SimpleOnGestureListener {
        C07524() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageTwentyFour.this.mPopupWindow != null) {
                if (CollageTwentyFour.this.mPopupWindow.isShowing()) {
                    CollageTwentyFour.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageTwentyFour.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageTwentyFour.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyFour$5 */
    class C07535 implements OnClickListener {
        C07535() {
        }

        public void onClick(View view) {
            CollageTwentyFour.this.mPopupWindow.dismiss();
            CollageTwentyFour.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyFour$6 */
    class C07546 implements OnClickListener {
        C07546() {
        }

        public void onClick(View view) {
            CollageTwentyFour.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageTwentyFour.this.getStoredBitmap(CollageTwentyFour.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageTwentyFour.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageTwentyFour.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyFour$7 */
    class C07557 implements OnClickListener {
        C07557() {
        }
    ...
    public static CollageTwentyFour newInstance(boolean b) {
        CollageTwentyFour fragment = new CollageTwentyFour();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_24, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageTwentyFour.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyFour$2$1 */
                class C07491 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageTwentyFour.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageTwentyFour.this.getActivity().runOnUiThread(new C07491());
                    }
                }
            });
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C07524());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C07535());
        delete.setOnClickListener(new C07546());
        cancel.setOnClickListener(new C07557());
    }
