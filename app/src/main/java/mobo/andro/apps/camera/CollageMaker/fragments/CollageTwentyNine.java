...
public class CollageTwentyNine extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyNine$3 */
    class C07593 implements Runnable {
        C07593() {
        }

        public void run() {
            CollageTwentyNine.this.setGridPadding(CollageTwentyNine.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyNine$4 */
    class C07604 extends SimpleOnGestureListener {
        C07604() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageTwentyNine.this.mPopupWindow != null) {
                if (CollageTwentyNine.this.mPopupWindow.isShowing()) {
                    CollageTwentyNine.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageTwentyNine.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageTwentyNine.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyNine$5 */
    class C07615 implements OnClickListener {
        ...
        public void onClick(View view) {
            CollageTwentyNine.this.mPopupWindow.dismiss();
            CollageTwentyNine.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyNine$6 */
    class C07626 implements OnClickListener {
        C07626() {
        }

        public void onClick(View view) {
            CollageTwentyNine.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageTwentyNine.this.getStoredBitmap(CollageTwentyNine.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageTwentyNine.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageTwentyNine.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyNine$7 */
    class C07637 implements OnClickListener {
        C07637() {
        }
    ...
    public static CollageTwentyNine newInstance(boolean b) {
        CollageTwentyNine fragment = new CollageTwentyNine();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_29, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageTwentyNine.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyNine$2$1 */
                class C07571 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageTwentyNine.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageTwentyNine.this.getActivity().runOnUiThread(new C07571());
                    }
                }
            });
    ...
    private void optimizeLayout(View view) {
        ...
        ImageUtils.optimizeView(this.rl3, 0.0f, 0.0f, Dimensions.MATCH_PARENT, Dimensions.S_4P);
        ImageUtils.optimizeView(this.rl4, 0.0f, (float) Dimensions.S_4P, Dimensions.MATCH_PARENT, Dimensions.S_4P);
        ImageUtils.optimizeView(this.rl5, 0.0f, (float) (Dimensions.S_4P * 2), Dimensions.MATCH_PARENT, Dimensions.S_4P);
        ImageUtils.optimizeView(this.rl6, 0.0f, (float) (Dimensions.S_4P * 3), Dimensions.MATCH_PARENT, Dimensions.S_4P);
        view.post(new C07593());
    }
    ...
    public void setGridPadding(int padding) {
        ...
        lp5.setMargins(this.curPadding / 2, this.curPadding, this.curPadding, this.curPadding);
        ...
        this.div2.setY((this.rl3.getY() + ((float) this.rl3.getHeight())) - ((float) (this.curPadding / 2)));
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C07604());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C07615());
        delete.setOnClickListener(new C07626());
        cancel.setOnClickListener(new C07637());
    }
