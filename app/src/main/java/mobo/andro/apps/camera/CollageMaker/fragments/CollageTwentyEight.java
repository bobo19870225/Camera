...
public class CollageTwentyEight extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyEight$3 */
    class C07353 implements Runnable {
        C07353() {
        }

        public void run() {
            CollageTwentyEight.this.setGridPadding(CollageTwentyEight.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyEight$4 */
    class C07364 extends SimpleOnGestureListener {
        C07364() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageTwentyEight.this.mPopupWindow != null) {
                if (CollageTwentyEight.this.mPopupWindow.isShowing()) {
                    CollageTwentyEight.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageTwentyEight.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageTwentyEight.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyEight$5 */
    class C07375 implements OnClickListener {
        C07375() {
        }

        public void onClick(View view) {
            CollageTwentyEight.this.mPopupWindow.dismiss();
            CollageTwentyEight.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyEight$6 */
    class C07386 implements OnClickListener {
        ...
        public void onClick(View view) {
            CollageTwentyEight.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageTwentyEight.this.getStoredBitmap(CollageTwentyEight.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageTwentyEight.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageTwentyEight.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyEight$7 */
    ...
    public static CollageTwentyEight newInstance(boolean b) {
        CollageTwentyEight fragment = new CollageTwentyEight();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_28, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageTwentyEight.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyEight$2$1 */
                class C07331 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageTwentyEight.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageTwentyEight.this.getActivity().runOnUiThread(new C07331());
                    }
                }
            });
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C07364());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C07375());
        delete.setOnClickListener(new C07386());
        cancel.setOnClickListener(new C07397());
    }
