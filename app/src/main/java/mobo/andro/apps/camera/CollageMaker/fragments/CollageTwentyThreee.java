...
public class CollageTwentyThreee extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyThreee$3 */
    class C07913 implements Runnable {
        C07913() {
        }

        public void run() {
            CollageTwentyThreee.this.setGridPadding(CollageTwentyThreee.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyThreee$4 */
    class C07924 extends SimpleOnGestureListener {
        C07924() {
        }
        ...
        public boolean onDoubleTap(MotionEvent e) {
            if (CollageTwentyThreee.this.mPopupWindow != null) {
                ...
                RelativeLayout main_rel = (RelativeLayout) CollageTwentyThreee.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageTwentyThreee.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyThreee$5 */
    class C07935 implements OnClickListener {
        C07935() {
        }

        public void onClick(View view) {
            CollageTwentyThreee.this.mPopupWindow.dismiss();
            CollageTwentyThreee.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyThreee$6 */
    class C07946 implements OnClickListener {
        C07946() {
        }

        public void onClick(View view) {
            CollageTwentyThreee.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageTwentyThreee.this.getStoredBitmap(CollageTwentyThreee.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageTwentyThreee.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageTwentyThreee.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyThreee$7 */
    class C07957 implements OnClickListener {
        C07957() {
        }
    ...
    public static CollageTwentyThreee newInstance(boolean b) {
        CollageTwentyThreee fragment = new CollageTwentyThreee();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_23, container, false);
    }
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyThreee$2$1 */
                class C07891 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageTwentyThreee.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageTwentyThreee.this.getActivity().runOnUiThread(new C07891());
                    }
                }
            });
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C07924());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C07935());
        delete.setOnClickListener(new C07946());
        cancel.setOnClickListener(new C07957());
    }
