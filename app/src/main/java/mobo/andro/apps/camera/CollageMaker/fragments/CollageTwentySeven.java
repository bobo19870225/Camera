...
public class CollageTwentySeven extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentySeven$3 */
    class C07753 implements Runnable {
        C07753() {
        }

        public void run() {
            CollageTwentySeven.this.setGridPadding(CollageTwentySeven.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentySeven$4 */
    class C07764 extends SimpleOnGestureListener {
        C07764() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageTwentySeven.this.mPopupWindow != null) {
                if (CollageTwentySeven.this.mPopupWindow.isShowing()) {
                    CollageTwentySeven.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageTwentySeven.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageTwentySeven.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentySeven$5 */
    class C07775 implements OnClickListener {
        C07775() {
        }

        public void onClick(View view) {
            CollageTwentySeven.this.mPopupWindow.dismiss();
            CollageTwentySeven.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentySeven$6 */
    class C07786 implements OnClickListener {
        C07786() {
        }

        public void onClick(View view) {
            CollageTwentySeven.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageTwentySeven.this.getStoredBitmap(CollageTwentySeven.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageTwentySeven.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageTwentySeven.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentySeven$7 */
    class C07797 implements OnClickListener {
        C07797() {
        }
    ...
    public static CollageTwentySeven newInstance(boolean b) {
        CollageTwentySeven fragment = new CollageTwentySeven();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_27, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageTwentySeven.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentySeven$2$1 */
                class C07731 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageTwentySeven.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageTwentySeven.this.getActivity().runOnUiThread(new C07731());
                    }
                }
            });
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C07764());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C07775());
        delete.setOnClickListener(new C07786());
        cancel.setOnClickListener(new C07797());
    }
