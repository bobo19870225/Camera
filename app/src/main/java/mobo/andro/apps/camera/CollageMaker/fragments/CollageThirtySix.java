...
public class CollageThirtySix extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtySix$3 */
    class C06873 implements Runnable {
        C06873() {
        }

        public void run() {
            CollageThirtySix.this.setGridPadding(CollageThirtySix.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtySix$4 */
    class C06884 extends SimpleOnGestureListener {
        C06884() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageThirtySix.this.mPopupWindow != null) {
                if (CollageThirtySix.this.mPopupWindow.isShowing()) {
                    CollageThirtySix.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageThirtySix.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageThirtySix.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtySix$5 */
    class C06895 implements OnClickListener {
        C06895() {
        }

        public void onClick(View view) {
            CollageThirtySix.this.mPopupWindow.dismiss();
            CollageThirtySix.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtySix$6 */
    class C06906 implements OnClickListener {
        C06906() {
        }

        public void onClick(View view) {
            CollageThirtySix.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageThirtySix.this.getStoredBitmap(CollageThirtySix.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageThirtySix.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageThirtySix.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtySix$7 */
    class C06917 implements OnClickListener {
        C06917() {
        }
    ...
    public static CollageThirtySix newInstance(boolean b) {
        CollageThirtySix fragment = new CollageThirtySix();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_36, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageThirtySix.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtySix$2$1 */
                class C06851 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageThirtySix.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageThirtySix.this.getActivity().runOnUiThread(new C06851());
                    }
                }
            });
    ...
    private void optimizeLayout(View view) {
        ...
        ImageUtils.optimizeView(this.rl6, 0.0f, 0.0f, Dimensions.S_3P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl7, (float) Dimensions.S_3P, 0.0f, Dimensions.S_3P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl8, (float) (Dimensions.S_3P * 2), 0.0f, Dimensions.S_3P, Dimensions.MATCH_PARENT);
        view.post(new C06873());
    }
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C06884());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C06895());
        delete.setOnClickListener(new C06906());
        cancel.setOnClickListener(new C06917());
    }
