...
public class CollageFourtyNine extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyNine$3 */
    class C05113 implements Runnable {
        C05113() {
        }

        public void run() {
            CollageFourtyNine.this.setGridPadding(CollageFourtyNine.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyNine$4 */
    class C05124 extends SimpleOnGestureListener {
        C05124() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageFourtyNine.this.mPopupWindow != null) {
                if (CollageFourtyNine.this.mPopupWindow.isShowing()) {
                    CollageFourtyNine.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageFourtyNine.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageFourtyNine.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyNine$5 */
    class C05135 implements OnClickListener {
        C05135() {
        }

        public void onClick(View view) {
            CollageFourtyNine.this.mPopupWindow.dismiss();
            CollageFourtyNine.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyNine$6 */
    class C05146 implements OnClickListener {
        C05146() {
        }

        public void onClick(View view) {
            CollageFourtyNine.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageFourtyNine.this.getStoredBitmap(CollageFourtyNine.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageFourtyNine.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageFourtyNine.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyNine$7 */
    class C05157 implements OnClickListener {
        C05157() {
        }
    ...
    public static CollageFourtyNine newInstance(boolean b) {
        CollageFourtyNine fragment = new CollageFourtyNine();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_49, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageFourtyNine.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyNine$2$1 */
                class C05091 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageFourtyNine.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageFourtyNine.this.getActivity().runOnUiThread(new C05091());
                    }
                }
            });
    ...
    private void optimizeLayout(View view) {
        ...
        ImageUtils.optimizeView(this.rl7, 0.0f, 0.0f, Dimensions.MATCH_PARENT, Dimensions.S_3P);
        ImageUtils.optimizeView(this.rl8, 0.0f, (float) Dimensions.S_3P, Dimensions.MATCH_PARENT, Dimensions.S_3P);
        ImageUtils.optimizeView(this.rl9, 0.0f, (float) (Dimensions.S_3P * 2), Dimensions.MATCH_PARENT, Dimensions.S_3P);
        ImageUtils.optimizeView(this.rl10, 0.0f, 0.0f, Dimensions.MATCH_PARENT, Dimensions.S_3P);
        ImageUtils.optimizeView(this.rl11, 0.0f, (float) Dimensions.S_3P, Dimensions.MATCH_PARENT, Dimensions.S_3P);
        ImageUtils.optimizeView(this.rl12, 0.0f, (float) (Dimensions.S_3P * 2), Dimensions.MATCH_PARENT, Dimensions.S_3P);
        view.post(new C05113());
    }
    ...
    public void setGridPadding(int padding) {
        ...
        lp3.setMargins(this.curPadding, this.curPadding / 2, this.curPadding / 2, this.curPadding);
        LayoutParams lp4 = (LayoutParams) this.fl4.getLayoutParams();
        lp4.setMargins(this.curPadding / 2, this.curPadding, this.curPadding / 2, this.curPadding / 2);
        ...
        lp6.setMargins(this.curPadding / 2, this.curPadding / 2, this.curPadding / 2, this.curPadding);
        ...
        this.div5.setY((float) (this.rl7.getHeight() - (this.curPadding / 2)));
        this.div6.setY((this.rl8.getY() + ((float) this.rl8.getHeight())) - ((float) (this.curPadding / 2)));
        this.div7.setY((float) (this.rl10.getHeight() - (this.curPadding / 2)));
        this.div8.setY((this.rl11.getY() + ((float) this.rl11.getHeight())) - ((float) (this.curPadding / 2)));
    }
                    ...
                    if (view.getId() != R.id.div2 || (view.getX() - ((float) dx)) + ((float) view.getWidth()) > this.rl3.getX() + ((float) this.rl3.getWidth()) || view.getX() - ((float) dx) < this.div1.getX()) {
                        if (view.getId() != R.id.div3 || (view.getY() - ((float) dy)) + ((float) view.getHeight()) > this.div4.getY() + ((float) this.div4.getHeight()) || view.getY() - ((float) dy) < 0.0f) {
                            if (view.getId() != R.id.div4 || (view.getY() - ((float) dy)) + ((float) view.getHeight()) > this.rl6.getY() + ((float) this.rl6.getHeight()) || view.getY() - ((float) dy) < this.div3.getY()) {
                                if (view.getId() != R.id.div5 || (view.getY() - ((float) dy)) + ((float) view.getHeight()) > this.div6.getY() + ((float) this.div6.getHeight()) || view.getY() - ((float) dy) < 0.0f) {
                                    if (view.getId() != R.id.div6 || (view.getY() - ((float) dy)) + ((float) view.getHeight()) > this.rl9.getY() + ((float) this.rl9.getHeight()) || view.getY() - ((float) dy) < this.div5.getY()) {
                                        if (view.getId() != R.id.div7 || (view.getY() - ((float) dy)) + ((float) view.getHeight()) > this.div8.getY() + ((float) this.div8.getHeight()) || view.getY() - ((float) dy) < 0.0f) {
                                            if (view.getId() == R.id.div8 && (view.getY() - ((float) dy)) + ((float) view.getHeight()) <= this.rl12.getY() + ((float) this.rl12.getHeight()) && view.getY() - ((float) dy) >= this.div7.getY()) {
                                        ...
                                        this.rl11.setY(this.rl11.getY() - ((float) dy));
                                        view.setY(view.getY() - ((float) dy));
                                        view.requestLayout();
                                        view.postInvalidate();
                                        break;
                                    ...
                                    this.rl9.setY(this.rl9.getY() - ((float) dy));
                                    view.setY(view.getY() - ((float) dy));
                                    view.requestLayout();
                                    view.postInvalidate();
                                    break;
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C05124());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C05135());
        delete.setOnClickListener(new C05146());
        cancel.setOnClickListener(new C05157());
    }
