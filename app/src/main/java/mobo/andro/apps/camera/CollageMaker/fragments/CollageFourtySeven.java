...
public class CollageFourtySeven extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtySeven$3 */
    class C05273 implements Runnable {
        C05273() {
        }

        public void run() {
            CollageFourtySeven.this.setGridPadding(CollageFourtySeven.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtySeven$4 */
    class C05284 extends SimpleOnGestureListener {
        C05284() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageFourtySeven.this.mPopupWindow != null) {
                if (CollageFourtySeven.this.mPopupWindow.isShowing()) {
                    CollageFourtySeven.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageFourtySeven.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageFourtySeven.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtySeven$5 */
    class C05295 implements OnClickListener {
        C05295() {
        }

        public void onClick(View view) {
            CollageFourtySeven.this.mPopupWindow.dismiss();
            CollageFourtySeven.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtySeven$6 */
    class C05306 implements OnClickListener {
        C05306() {
        }

        public void onClick(View view) {
            CollageFourtySeven.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageFourtySeven.this.getStoredBitmap(CollageFourtySeven.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageFourtySeven.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageFourtySeven.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtySeven$7 */
    ...
    public static CollageFourtySeven newInstance(boolean b) {
        CollageFourtySeven fragment = new CollageFourtySeven();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_47, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageFourtySeven.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtySeven$2$1 */
                class C05251 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageFourtySeven.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageFourtySeven.this.getActivity().runOnUiThread(new C05251());
                    }
                }
            });
    ...
    private void optimizeLayout(View view) {
        ...
        ImageUtils.optimizeView(this.rl3, 0.0f, 0.0f, Dimensions.MATCH_PARENT, Dimensions.S_2P);
        ImageUtils.optimizeView(this.rl4, 0.0f, (float) Dimensions.S_2P, Dimensions.MATCH_PARENT, Dimensions.S_2P);
        ImageUtils.optimizeView(this.rl5, 0.0f, 0.0f, Dimensions.MATCH_PARENT, Dimensions.S_4P);
        ImageUtils.optimizeView(this.rl6, 0.0f, (float) Dimensions.S_4P, Dimensions.MATCH_PARENT, Dimensions.S_4P);
        ImageUtils.optimizeView(this.rl7, 0.0f, (float) (Dimensions.S_4P * 2), Dimensions.MATCH_PARENT, Dimensions.S_4P);
        ImageUtils.optimizeView(this.rl8, 0.0f, (float) (Dimensions.S_4P * 3), Dimensions.MATCH_PARENT, Dimensions.S_4P);
        ImageUtils.optimizeView(this.rl9, 0.0f, 0.0f, Dimensions.S_4P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl10, (float) Dimensions.S_4P, 0.0f, Dimensions.S_4P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl11, 0.0f, 0.0f, Dimensions.S_4P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl12, (float) Dimensions.S_4P, 0.0f, Dimensions.S_4P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl13, 0.0f, 0.0f, Dimensions.S_4P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl14, (float) Dimensions.S_4P, 0.0f, Dimensions.S_4P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl15, 0.0f, 0.0f, Dimensions.S_4P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl16, (float) Dimensions.S_4P, 0.0f, Dimensions.S_4P, Dimensions.MATCH_PARENT);
        view.post(new C05273());
    }
    ...
    public void setGridPadding(int padding) {
        ...
        lp3.setMargins(this.curPadding, this.curPadding / 2, this.curPadding / 2, this.curPadding / 2);
        ...
        lp5.setMargins(this.curPadding, this.curPadding / 2, this.curPadding / 2, this.curPadding / 2);
        ...
        lp7.setMargins(this.curPadding, this.curPadding / 2, this.curPadding / 2, this.curPadding);
        LayoutParams lp8 = (LayoutParams) this.fl8.getLayoutParams();
        lp8.setMargins(this.curPadding / 2, this.curPadding / 2, this.curPadding / 2, this.curPadding);
        LayoutParams lp9 = (LayoutParams) this.fl9.getLayoutParams();
        lp9.setMargins(this.curPadding / 2, this.curPadding, this.curPadding, this.curPadding);
        ...
        this.div2.setY((float) (this.rl3.getHeight() - (this.curPadding / 2)));
        this.div3.setY((float) (this.rl5.getHeight() - (this.curPadding / 2)));
        this.div4.setY((this.rl6.getY() + ((float) this.rl6.getHeight())) - ((float) (this.curPadding / 2)));
        this.div5.setY((this.rl7.getY() + ((float) this.rl7.getHeight())) - ((float) (this.curPadding / 2)));
        this.div6.setX((float) (this.rl9.getWidth() - (this.curPadding / 2)));
        this.div7.setX((float) (this.rl11.getWidth() - (this.curPadding / 2)));
        this.div8.setX((float) (this.rl13.getWidth() - (this.curPadding / 2)));
        this.div9.setX((float) (this.rl15.getWidth() - (this.curPadding / 2)));
    }
        ...
        switch (motionEvent.getAction()) {
            ...
            case 2:
                ...
                if (view.getId() != R.id.div1 || (view.getX() - ((float) dx)) + ((float) view.getWidth()) > this.rl2.getX() + ((float) this.rl2.getWidth()) || view.getX() - ((float) dx) < 0.0f) {
                    if (view.getId() != R.id.div2 || (view.getY() - ((float) dy)) + ((float) view.getHeight()) > this.rl4.getY() + ((float) this.rl4.getHeight()) || view.getY() - ((float) dy) < 0.0f) {
                        if (view.getId() != R.id.div3 || (view.getY() - ((float) dy)) + ((float) view.getHeight()) > this.div4.getY() + ((float) this.div4.getHeight()) || view.getY() - ((float) dy) < 0.0f) {
                            if (view.getId() != R.id.div4 || (view.getY() - ((float) dy)) + ((float) view.getHeight()) > this.div5.getY() + ((float) this.div5.getHeight()) || view.getY() - ((float) dy) < this.div3.getY()) {
                                if (view.getId() != R.id.div5 || (view.getY() - ((float) dy)) + ((float) view.getHeight()) > this.rl8.getY() + ((float) this.rl8.getHeight()) || view.getY() - ((float) dy) < this.div4.getY()) {
                                    if (view.getId() != R.id.div6 || (view.getX() - ((float) dx)) + ((float) view.getWidth()) > this.rl10.getX() + ((float) this.rl10.getWidth()) || view.getX() - ((float) dx) < 0.0f) {
                                        if (view.getId() != R.id.div7 || (view.getX() - ((float) dx)) + ((float) view.getWidth()) > this.rl12.getX() + ((float) this.rl12.getWidth()) || view.getX() - ((float) dx) < 0.0f) {
                                            if (view.getId() != R.id.div8 || (view.getX() - ((float) dx)) + ((float) view.getWidth()) > this.rl14.getX() + ((float) this.rl14.getWidth()) || view.getX() - ((float) dx) < 0.0f) {
                                                if (view.getId() == R.id.div9 && (view.getX() - ((float) dx)) + ((float) view.getWidth()) <= this.rl16.getX() + ((float) this.rl16.getWidth()) && view.getX() - ((float) dx) >= 0.0f) {
                                                    this.rl15.getLayoutParams().width -= dx;
                                                    if (this.rl15.getLayoutParams().width >= 0) {
                                                        this.rl15.setVisibility(View.VISIBLE);
                                                    } else {
                                                        this.rl15.setVisibility(View.GONE);
                                                    }
                                                    this.rl16.getLayoutParams().width += dx;
                                                    if (this.rl16.getLayoutParams().width >= 0) {
                                                        this.rl16.setVisibility(View.VISIBLE);
                                                    } else {
                                                        this.rl16.setVisibility(View.GONE);
                                                    }
                                                    this.rl16.setX(this.rl16.getX() - ((float) dx));
                    ...
                    this.rl4.setY(this.rl4.getY() - ((float) dy));
                    view.setY(view.getY() - ((float) dy));
                    view.requestLayout();
                    view.postInvalidate();
                    break;
                ...
                if (this.rl1.getLayoutParams().width > this.rl9.getLayoutParams().width) {
                    this.rl10.getLayoutParams().width = this.rl1.getLayoutParams().width - this.rl9.getLayoutParams().width;
                }
                if (this.rl1.getLayoutParams().width > this.rl11.getLayoutParams().width) {
                    this.rl12.getLayoutParams().width = this.rl1.getLayoutParams().width - this.rl11.getLayoutParams().width;
                }
                if (this.rl1.getLayoutParams().width > this.rl13.getLayoutParams().width) {
                    this.rl14.getLayoutParams().width = this.rl1.getLayoutParams().width - this.rl13.getLayoutParams().width;
                }
                if (this.rl1.getLayoutParams().width > this.rl15.getLayoutParams().width) {
                    this.rl16.getLayoutParams().width = this.rl1.getLayoutParams().width - this.rl15.getLayoutParams().width;
                }
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C05284());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C05295());
        delete.setOnClickListener(new C05306());
        cancel.setOnClickListener(new C05317());
    }
