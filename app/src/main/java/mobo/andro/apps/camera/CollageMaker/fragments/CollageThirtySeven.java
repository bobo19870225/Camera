...
public class CollageThirtySeven extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtySeven$3 */
    class C06793 implements Runnable {
        C06793() {
        }

        public void run() {
            CollageThirtySeven.this.setGridPadding(CollageThirtySeven.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtySeven$4 */
    class C06804 extends SimpleOnGestureListener {
        C06804() {
        }
        ...
        public boolean onDoubleTap(MotionEvent e) {
            if (CollageThirtySeven.this.mPopupWindow != null) {
                ...
                RelativeLayout main_rel = (RelativeLayout) CollageThirtySeven.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageThirtySeven.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtySeven$5 */
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtySeven$6 */
    class C06826 implements OnClickListener {
        C06826() {
        }

        public void onClick(View view) {
            CollageThirtySeven.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageThirtySeven.this.getStoredBitmap(CollageThirtySeven.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageThirtySeven.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageThirtySeven.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtySeven$7 */
    ...
    public static CollageThirtySeven newInstance(boolean b) {
        CollageThirtySeven fragment = new CollageThirtySeven();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_37, container, false);
    }
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtySeven$2$1 */
                class C06771 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageThirtySeven.this.img1.getmCurConfig());
    ...
    private void optimizeLayout(View view) {
        ...
        ImageUtils.optimizeView(this.rl2, 0.0f, (float) (Dimensions.S_3P * 2), Dimensions.MATCH_PARENT, Dimensions.S_3P);
        ImageUtils.optimizeView(this.rl3, 0.0f, 0.0f, Dimensions.S_3P * 2, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl4, (float) (Dimensions.S_3P * 2), 0.0f, Dimensions.S_3P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl5, 0.0f, 0.0f, Dimensions.MATCH_PARENT, Dimensions.S_3P);
        ImageUtils.optimizeView(this.rl6, 0.0f, (float) Dimensions.S_3P, Dimensions.MATCH_PARENT, Dimensions.S_3P);
    ...
    public void setGridPadding(int padding) {
        ...
        lp5.setMargins(this.curPadding / 2, this.curPadding / 2, this.curPadding / 2, this.curPadding);
        ...
        this.div4.setX((float) (this.rl7.getWidth() - (this.curPadding / 2)));
            ...
            case 2:
                ...
                if (view.getId() != R.id.div1 || (view.getY() - ((float) dy)) + ((float) view.getHeight()) > this.rl2.getY() + ((float) this.rl2.getHeight()) || view.getY() - ((float) dy) < 0.0f) {
                    if (view.getId() != R.id.div2 || (view.getX() - ((float) dx)) + ((float) view.getWidth()) > this.rl4.getX() + ((float) this.rl4.getWidth()) || view.getX() - ((float) dx) < 0.0f) {
                        if (view.getId() != R.id.div3 || (view.getY() - ((float) dy)) + ((float) view.getHeight()) > this.div1.getY() + ((float) this.div1.getHeight()) || view.getY() - ((float) dy) < 0.0f) {
                            if (view.getId() != R.id.div4 || (view.getX() - ((float) dx)) + ((float) view.getWidth()) > this.div5.getX() + ((float) this.div5.getWidth()) || view.getX() - ((float) dx) < 0.0f) {
                                if (view.getId() == R.id.div5 && (view.getX() - ((float) dx)) + ((float) view.getWidth()) <= this.rl9.getX() + ((float) this.rl9.getWidth()) && view.getX() - ((float) dx) >= this.div4.getX()) {
                ...
                if (this.rl1.getLayoutParams().height > this.rl5.getLayoutParams().height) {
                    this.rl6.getLayoutParams().height = this.rl1.getLayoutParams().height - this.rl5.getLayoutParams().height;
                }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C06815());
        delete.setOnClickListener(new C06826());
        cancel.setOnClickListener(new C06837());
    }
