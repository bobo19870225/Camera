...
public class CollageNine extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageNine$3 */
    class C05593 implements Runnable {
        C05593() {
        }

        public void run() {
            CollageNine.this.setGridPadding(CollageNine.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageNine$4 */
    class C05604 extends SimpleOnGestureListener {
        C05604() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageNine.this.mPopupWindow != null) {
                if (CollageNine.this.mPopupWindow.isShowing()) {
                    CollageNine.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageNine.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageNine.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageNine$5 */
    class C05615 implements OnClickListener {
        ...
        public void onClick(View view) {
            CollageNine.this.mPopupWindow.dismiss();
            CollageNine.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageNine$6 */
    class C05626 implements OnClickListener {
        C05626() {
        }

        public void onClick(View view) {
            CollageNine.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageNine.this.getStoredBitmap(CollageNine.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageNine.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageNine.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageNine$7 */
    class C05637 implements OnClickListener {
        C05637() {
        }
    ...
    public static CollageNine newInstance(boolean b) {
        CollageNine fragment = new CollageNine();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_9, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageNine.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageNine$2$1 */
                class C05571 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageNine.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageNine.this.getActivity().runOnUiThread(new C05571());
                    }
                }
            });
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C05604());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C05615());
        delete.setOnClickListener(new C05626());
        cancel.setOnClickListener(new C05637());
    }
