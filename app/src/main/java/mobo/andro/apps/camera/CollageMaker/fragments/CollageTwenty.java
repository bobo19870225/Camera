...
public class CollageTwenty extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwenty$3 */
    class C07273 implements Runnable {
        C07273() {
        }

        public void run() {
            CollageTwenty.this.setGridPadding(CollageTwenty.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwenty$4 */
    class C07284 extends SimpleOnGestureListener {
        C07284() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageTwenty.this.mPopupWindow != null) {
                if (CollageTwenty.this.mPopupWindow.isShowing()) {
                    CollageTwenty.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageTwenty.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageTwenty.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwenty$5 */
    class C07295 implements OnClickListener {
        ...
        public void onClick(View view) {
            CollageTwenty.this.mPopupWindow.dismiss();
            CollageTwenty.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwenty$6 */
    class C07306 implements OnClickListener {
        ...
        public void onClick(View view) {
            CollageTwenty.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageTwenty.this.getStoredBitmap(CollageTwenty.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageTwenty.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageTwenty.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwenty$7 */
    class C07317 implements OnClickListener {
        C07317() {
        }
    ...
    public static CollageTwenty newInstance(boolean b) {
        CollageTwenty fragment = new CollageTwenty();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_20, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageTwenty.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwenty$2$1 */
                class C07251 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageTwenty.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageTwenty.this.getActivity().runOnUiThread(new C07251());
                    }
                }
            });
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C07284());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C07295());
        delete.setOnClickListener(new C07306());
        cancel.setOnClickListener(new C07317());
    }
