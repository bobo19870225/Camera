...
public class CollageExtraTwo extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageExtraTwo$3 */
    class C04313 implements Runnable {
        C04313() {
        }

        public void run() {
            CollageExtraTwo.this.setGridPadding(CollageExtraTwo.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageExtraTwo$4 */
    class C04324 extends SimpleOnGestureListener {
        C04324() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageExtraTwo.this.mPopupWindow != null) {
                if (CollageExtraTwo.this.mPopupWindow.isShowing()) {
                    CollageExtraTwo.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageExtraTwo.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageExtraTwo.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageExtraTwo$5 */
    class C04335 implements OnClickListener {
        C04335() {
        }

        public void onClick(View view) {
            CollageExtraTwo.this.mPopupWindow.dismiss();
            CollageExtraTwo.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageExtraTwo$6 */
    class C04346 implements OnClickListener {
        C04346() {
        }

        public void onClick(View view) {
            CollageExtraTwo.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageExtraTwo.this.getStoredBitmap(CollageExtraTwo.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageExtraTwo.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageExtraTwo.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageExtraTwo$7 */
    class C04357 implements OnClickListener {
        C04357() {
        }
    ...
    public static CollageExtraTwo newInstance(boolean b) {
        CollageExtraTwo fragment = new CollageExtraTwo();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_e2, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageExtraTwo.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageExtraTwo$2$1 */
                class C04291 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageExtraTwo.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageExtraTwo.this.getActivity().runOnUiThread(new C04291());
                    }
                }
            });
    ...
    public void setGridPadding(int padding) {
        ...
        lp6.setMargins(this.curPadding, this.curPadding / 2, this.curPadding / 2, this.curPadding);
        LayoutParams lp7 = (LayoutParams) this.fl7.getLayoutParams();
        lp7.setMargins(this.curPadding / 2, this.curPadding / 2, this.curPadding, this.curPadding);
        ...
        this.div6.setX((this.rl9.getX() + ((float) this.rl9.getWidth())) - ((float) (this.curPadding / 2)));
    }
                ...
                if (view.getId() != R.id.div1 || (view.getY() - ((float) dy)) + ((float) view.getHeight()) > this.div2.getY() + ((float) this.div2.getHeight()) || view.getY() - ((float) dy) < 0.0f) {
                    if (view.getId() != R.id.div2 || (view.getY() - ((float) dy)) + ((float) view.getHeight()) > this.rl3.getY() + ((float) this.rl3.getHeight()) || view.getY() - ((float) dy) < this.div1.getY()) {
                        if (view.getId() != R.id.div3 || (view.getX() - ((float) dx)) + ((float) view.getWidth()) > this.div4.getX() + ((float) this.div4.getWidth()) || view.getX() - ((float) dx) < 0.0f) {
                            if (view.getId() != R.id.div4 || (view.getX() - ((float) dx)) + ((float) view.getWidth()) > this.rl6.getX() + ((float) this.rl6.getWidth()) || view.getX() - ((float) dx) < this.div3.getX()) {
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C04324());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C04335());
        delete.setOnClickListener(new C04346());
        cancel.setOnClickListener(new C04357());
    }
