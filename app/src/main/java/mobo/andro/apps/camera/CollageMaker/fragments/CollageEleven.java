...
public class CollageEleven extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageEleven$3 */
    class C04153 implements Runnable {
        C04153() {
        }

        public void run() {
            CollageEleven.this.setGridPadding(CollageEleven.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageEleven$4 */
    class C04164 extends SimpleOnGestureListener {
        C04164() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageEleven.this.mPopupWindow != null) {
                if (CollageEleven.this.mPopupWindow.isShowing()) {
                    CollageEleven.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageEleven.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageEleven.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageEleven$5 */
    class C04175 implements OnClickListener {
        ...
        public void onClick(View view) {
            CollageEleven.this.mPopupWindow.dismiss();
            CollageEleven.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageEleven$6 */
    class C04186 implements OnClickListener {
        ...
        public void onClick(View view) {
            CollageEleven.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageEleven.this.getStoredBitmap(CollageEleven.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageEleven.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageEleven.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageEleven$7 */
    ...
    public static CollageEleven newInstance(boolean b) {
        CollageEleven fragment = new CollageEleven();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_11, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageEleven.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageEleven$2$1 */
                class C04131 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageEleven.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageEleven.this.getActivity().runOnUiThread(new C04131());
                    }
                }
            });
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C04164());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C04175());
        delete.setOnClickListener(new C04186());
        cancel.setOnClickListener(new C04197());
    }
