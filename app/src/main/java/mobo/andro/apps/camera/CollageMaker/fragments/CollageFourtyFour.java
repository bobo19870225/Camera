...
public class CollageFourtyFour extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyFour$3 */
    class C05033 implements Runnable {
        C05033() {
        }

        public void run() {
            CollageFourtyFour.this.setGridPadding(CollageFourtyFour.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyFour$4 */
    class C05044 extends SimpleOnGestureListener {
        C05044() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageFourtyFour.this.mPopupWindow != null) {
                if (CollageFourtyFour.this.mPopupWindow.isShowing()) {
                    CollageFourtyFour.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageFourtyFour.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageFourtyFour.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyFour$5 */
    class C05055 implements OnClickListener {
        ...
        public void onClick(View view) {
            CollageFourtyFour.this.mPopupWindow.dismiss();
            CollageFourtyFour.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyFour$6 */
    class C05066 implements OnClickListener {
        ...
        public void onClick(View view) {
            CollageFourtyFour.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageFourtyFour.this.getStoredBitmap(CollageFourtyFour.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageFourtyFour.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageFourtyFour.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyFour$7 */
    ...
    public static CollageFourtyFour newInstance(boolean b) {
        CollageFourtyFour fragment = new CollageFourtyFour();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_44, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageFourtyFour.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyFour$2$1 */
                class C05011 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageFourtyFour.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageFourtyFour.this.getActivity().runOnUiThread(new C05011());
                    }
                }
            });
    ...
    public void setGridPadding(int padding) {
        ...
        lp9.setMargins(this.curPadding / 2, this.curPadding / 2, this.curPadding, this.curPadding / 2);
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        switch (motionEvent.getAction()) {
            ...
            case 2:
                ...
                this.rl10.getLayoutParams().height = this.rl2.getLayoutParams().height - this.rl9.getLayoutParams().height;
                this.rl12.getLayoutParams().height = this.rl2.getLayoutParams().height - this.rl11.getLayoutParams().height;
                this.rl14.getLayoutParams().height = this.rl2.getLayoutParams().height - this.rl13.getLayoutParams().height;
                this.rl16.getLayoutParams().height = this.rl2.getLayoutParams().height - this.rl15.getLayoutParams().height;
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C05044());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C05055());
        delete.setOnClickListener(new C05066());
        cancel.setOnClickListener(new C05077());
    }
