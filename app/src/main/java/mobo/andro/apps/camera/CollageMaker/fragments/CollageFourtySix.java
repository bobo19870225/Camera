...
public class CollageFourtySix extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtySix$3 */
    class C05353 implements Runnable {
        C05353() {
        }

        public void run() {
            CollageFourtySix.this.setGridPadding(CollageFourtySix.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtySix$4 */
    class C05364 extends SimpleOnGestureListener {
        C05364() {
        }
        ...
        public boolean onDoubleTap(MotionEvent e) {
            if (CollageFourtySix.this.mPopupWindow != null) {
                ...
                RelativeLayout main_rel = (RelativeLayout) CollageFourtySix.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageFourtySix.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtySix$5 */
    class C05375 implements OnClickListener {
        ...
        public void onClick(View view) {
            CollageFourtySix.this.mPopupWindow.dismiss();
            CollageFourtySix.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtySix$6 */
    class C05386 implements OnClickListener {
        C05386() {
        }

        public void onClick(View view) {
            CollageFourtySix.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageFourtySix.this.getStoredBitmap(CollageFourtySix.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageFourtySix.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageFourtySix.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtySix$7 */
    ...
    public static CollageFourtySix newInstance(boolean b) {
        CollageFourtySix fragment = new CollageFourtySix();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_46, container, false);
    }
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtySix$2$1 */
                class C05331 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageFourtySix.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageFourtySix.this.getActivity().runOnUiThread(new C05331());
                    }
                }
            });
    ...
    public void setGridPadding(int padding) {
        ...
        lp5.setMargins(this.curPadding / 2, this.curPadding / 2, this.curPadding / 2, this.curPadding / 2);
        LayoutParams lp6 = (LayoutParams) this.fl6.getLayoutParams();
        lp6.setMargins(this.curPadding / 2, this.curPadding / 2, this.curPadding, this.curPadding / 2);
        LayoutParams lp7 = (LayoutParams) this.fl7.getLayoutParams();
        lp7.setMargins(this.curPadding / 2, this.curPadding / 2, this.curPadding / 2, this.curPadding / 2);
        ...
        lp9.setMargins(this.curPadding / 2, this.curPadding / 2, this.curPadding / 2, this.curPadding);
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C05364());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C05375());
        delete.setOnClickListener(new C05386());
        cancel.setOnClickListener(new C05397());
    }
