...
public class CollageFourtyTwo extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyTwo$3 */
    class C05513 implements Runnable {
        C05513() {
        }

        public void run() {
            CollageFourtyTwo.this.setGridPadding(CollageFourtyTwo.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyTwo$4 */
    class C05524 extends SimpleOnGestureListener {
        C05524() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageFourtyTwo.this.mPopupWindow != null) {
                if (CollageFourtyTwo.this.mPopupWindow.isShowing()) {
                    CollageFourtyTwo.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageFourtyTwo.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageFourtyTwo.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyTwo$5 */
    class C05535 implements OnClickListener {
        ...
        public void onClick(View view) {
            CollageFourtyTwo.this.mPopupWindow.dismiss();
            CollageFourtyTwo.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyTwo$6 */
    class C05546 implements OnClickListener {
        ...
        public void onClick(View view) {
            CollageFourtyTwo.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageFourtyTwo.this.getStoredBitmap(CollageFourtyTwo.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageFourtyTwo.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageFourtyTwo.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyTwo$7 */
    class C05557 implements OnClickListener {
        C05557() {
        }
    ...
    public static CollageFourtyTwo newInstance(boolean b) {
        CollageFourtyTwo fragment = new CollageFourtyTwo();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_42, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageFourtyTwo.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyTwo$2$1 */
                class C05491 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageFourtyTwo.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageFourtyTwo.this.getActivity().runOnUiThread(new C05491());
                    }
                }
            });
    ...
    private void optimizeLayout(View view) {
        ...
        ImageUtils.optimizeView(this.rl5, 0.0f, 0.0f, Dimensions.MATCH_PARENT, Dimensions.S_2P);
        ImageUtils.optimizeView(this.rl6, 0.0f, (float) Dimensions.S_2P, Dimensions.MATCH_PARENT, Dimensions.S_2P);
        ImageUtils.optimizeView(this.rl7, 0.0f, 0.0f, Dimensions.MATCH_PARENT, Dimensions.S_2P);
        ImageUtils.optimizeView(this.rl8, 0.0f, (float) Dimensions.S_2P, Dimensions.MATCH_PARENT, Dimensions.S_2P);
        ImageUtils.optimizeView(this.rl9, 0.0f, 0.0f, Dimensions.MATCH_PARENT, Dimensions.S_2P);
        ImageUtils.optimizeView(this.rl10, 0.0f, (float) Dimensions.S_2P, Dimensions.MATCH_PARENT, Dimensions.S_2P);
        ImageUtils.optimizeView(this.rl11, 0.0f, 0.0f, Dimensions.MATCH_PARENT, Dimensions.S_2P);
        ImageUtils.optimizeView(this.rl12, 0.0f, (float) Dimensions.S_2P, Dimensions.MATCH_PARENT, Dimensions.S_2P);
        view.post(new C05513());
    }
    ...
    public void setGridPadding(int padding) {
        ...
        lp4.setMargins(this.curPadding / 2, this.curPadding / 2, this.curPadding / 2, this.curPadding);
        ...
        this.div4.setY((float) (this.rl5.getHeight() - (this.curPadding / 2)));
                ...
                if (view.getId() != R.id.div1 || (view.getX() - ((float) dx)) + ((float) view.getWidth()) > this.div2.getX() + ((float) this.div2.getWidth()) || view.getX() - ((float) dx) < 0.0f) {
                    if (view.getId() != R.id.div2 || (view.getX() - ((float) dx)) + ((float) view.getWidth()) > this.div3.getX() + ((float) this.div3.getWidth()) || view.getX() - ((float) dx) < this.div1.getX()) {
                        if (view.getId() != R.id.div3 || (view.getX() - ((float) dx)) + ((float) view.getWidth()) > this.rl4.getX() + ((float) this.rl4.getWidth()) || view.getX() - ((float) dx) < this.div2.getX()) {
                            if (view.getId() != R.id.div4 || (view.getY() - ((float) dy)) + ((float) view.getHeight()) > this.rl6.getY() + ((float) this.rl6.getHeight()) || view.getY() - ((float) dy) < 0.0f) {
                                if (view.getId() != R.id.div5 || (view.getY() - ((float) dy)) + ((float) view.getHeight()) > this.rl8.getY() + ((float) this.rl8.getHeight()) || view.getY() - ((float) dy) < 0.0f) {
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C05524());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C05535());
        delete.setOnClickListener(new C05546());
        cancel.setOnClickListener(new C05557());
    }
