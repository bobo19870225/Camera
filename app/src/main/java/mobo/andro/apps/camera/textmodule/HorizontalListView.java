...
public class HorizontalListView extends AdapterView<ListAdapter> {
    ...
    private DataSetObserver mDataObserver = new C08841();
    private int mDisplayOffset = 0;
    private GestureDetector mGesture;
    private int mLeftViewIndex = -1;
    private int mMaxX = Integer.MAX_VALUE;
    protected int mNextX;
    private OnGestureListener mOnGesture = new C08863();
    ...
    /* renamed from: mobo.andro.apps.camera.textmodule.HorizontalListView$1 */
    class C08841 extends DataSetObserver {
        C08841() {
        }
    ...
    /* renamed from: mobo.andro.apps.camera.textmodule.HorizontalListView$2 */
    ...
    /* renamed from: mobo.andro.apps.camera.textmodule.HorizontalListView$3 */
    class C08863 extends SimpleOnGestureListener {
        C08863() {
        }
