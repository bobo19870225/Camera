...
public class CollageThirtyNine extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtyNine$3 */
    class C06633 implements Runnable {
        C06633() {
        }

        public void run() {
            CollageThirtyNine.this.setGridPadding(CollageThirtyNine.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtyNine$4 */
    class C06644 extends SimpleOnGestureListener {
        C06644() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageThirtyNine.this.mPopupWindow != null) {
                if (CollageThirtyNine.this.mPopupWindow.isShowing()) {
                    CollageThirtyNine.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageThirtyNine.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageThirtyNine.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtyNine$5 */
    class C06655 implements OnClickListener {
        C06655() {
        }

        public void onClick(View view) {
            CollageThirtyNine.this.mPopupWindow.dismiss();
            CollageThirtyNine.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtyNine$6 */
    class C06666 implements OnClickListener {
        C06666() {
        }

        public void onClick(View view) {
            CollageThirtyNine.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageThirtyNine.this.getStoredBitmap(CollageThirtyNine.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageThirtyNine.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageThirtyNine.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtyNine$7 */
    class C06677 implements OnClickListener {
        C06677() {
        }
    ...
    public static CollageThirtyNine newInstance(boolean b) {
        CollageThirtyNine fragment = new CollageThirtyNine();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_39, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageThirtyNine.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtyNine$2$1 */
                class C06611 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageThirtyNine.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageThirtyNine.this.getActivity().runOnUiThread(new C06611());
                    }
                }
            });
    ...
    private void optimizeLayout(View view) {
        ...
        ImageUtils.optimizeView(this.rl2, (float) Dimensions.S_3P, 0.0f, Dimensions.S_3P * 2, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl3, 0.0f, 0.0f, Dimensions.MATCH_PARENT, Dimensions.S_3P);
        ImageUtils.optimizeView(this.rl4, 0.0f, (float) Dimensions.S_3P, Dimensions.MATCH_PARENT, Dimensions.S_3P);
        ImageUtils.optimizeView(this.rl5, 0.0f, (float) (Dimensions.S_3P * 2), Dimensions.MATCH_PARENT, Dimensions.S_3P);
        ImageUtils.optimizeView(this.rl6, 0.0f, 0.0f, Dimensions.MATCH_PARENT, Dimensions.S_3P);
        ImageUtils.optimizeView(this.rl7, 0.0f, (float) Dimensions.S_3P, Dimensions.MATCH_PARENT, Dimensions.S_3P * 2);
        ImageUtils.optimizeView(this.rl8, 0.0f, 0.0f, Dimensions.S_3P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl9, (float) Dimensions.S_3P, 0.0f, Dimensions.S_3P, Dimensions.MATCH_PARENT);
        view.post(new C06633());
    }
    ...
    public void setGridPadding(int padding) {
        ...
        lp5.setMargins(this.curPadding / 2, this.curPadding, this.curPadding, this.curPadding / 2);
        ...
        this.div3.setY((this.rl4.getY() + ((float) this.rl4.getHeight())) - ((float) (this.curPadding / 2)));
        this.div4.setY((float) (this.rl6.getHeight() - (this.curPadding / 2)));
        this.div5.setX((this.rl8.getX() + ((float) this.rl8.getWidth())) - ((float) (this.curPadding / 2)));
    }
        ...
        switch (motionEvent.getAction()) {
            ...
            case 2:
                ...
                if (view.getId() != R.id.div1 || (view.getX() - ((float) dx)) + ((float) view.getWidth()) > this.rl2.getX() + ((float) this.rl2.getWidth()) || view.getX() - ((float) dx) < 0.0f) {
                    if (view.getId() != R.id.div2 || (view.getY() - ((float) dy)) + ((float) view.getHeight()) > this.div3.getY() + ((float) this.div3.getHeight()) || view.getY() - ((float) dy) < 0.0f) {
                        if (view.getId() != R.id.div3 || (view.getY() - ((float) dy)) + ((float) view.getHeight()) > this.rl5.getY() + ((float) this.rl5.getHeight()) || view.getY() - ((float) dy) < this.div2.getY()) {
                            if (view.getId() != R.id.div4 || (view.getY() - ((float) dy)) + ((float) view.getHeight()) > this.rl7.getY() + ((float) this.rl7.getHeight()) || view.getY() - ((float) dy) < 0.0f) {
                                if (view.getId() == R.id.div5 && (view.getX() - ((float) dx)) + ((float) view.getWidth()) <= this.rl9.getX() + ((float) this.rl9.getWidth()) && view.getX() - ((float) dx) >= ((float) (0 - (this.curPadding / 2)))) {
                                    ...
                                    this.rl9.requestLayout();
                                    this.rl9.postInvalidate();
                ...
                this.rl9.getLayoutParams().width = this.rl2.getLayoutParams().width - this.rl8.getLayoutParams().width;
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C06644());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C06655());
        delete.setOnClickListener(new C06666());
        cancel.setOnClickListener(new C06677());
    }
