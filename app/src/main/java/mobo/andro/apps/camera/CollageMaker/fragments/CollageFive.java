...
public class CollageFive extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFive$3 */
    class C04553 implements Runnable {
        C04553() {
        }

        public void run() {
            CollageFive.this.setGridPadding(CollageFive.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFive$4 */
    class C04564 extends SimpleOnGestureListener {
        C04564() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageFive.this.mPopupWindow != null) {
                if (CollageFive.this.mPopupWindow.isShowing()) {
                    CollageFive.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageFive.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageFive.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFive$5 */
    class C04575 implements OnClickListener {
        C04575() {
        }

        public void onClick(View view) {
            CollageFive.this.mPopupWindow.dismiss();
            CollageFive.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFive$6 */
    class C04586 implements OnClickListener {
        C04586() {
        }

        public void onClick(View view) {
            CollageFive.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageFive.this.getStoredBitmap(CollageFive.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageFive.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageFive.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFive$7 */
    class C04597 implements OnClickListener {
        C04597() {
        }
    ...
    public static CollageFive newInstance(boolean b) {
        CollageFive fragment = new CollageFive();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_5, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageFive.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFive$2$1 */
                class C04531 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageFive.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageFive.this.getActivity().runOnUiThread(new C04531());
                    }
                }
            });
    ...
    public void setGridPadding(int padding) {
        ...
        lp3.setMargins(this.curPadding / 2, this.curPadding / 2, this.curPadding, this.curPadding);
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C04564());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C04575());
        delete.setOnClickListener(new C04586());
        cancel.setOnClickListener(new C04597());
    }
