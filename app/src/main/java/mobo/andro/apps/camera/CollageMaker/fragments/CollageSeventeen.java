...
public class CollageSeventeen extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageSeventeen$3 */
    class C05913 implements Runnable {
        C05913() {
        }

        public void run() {
            CollageSeventeen.this.setGridPadding(CollageSeventeen.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageSeventeen$4 */
    class C05924 extends SimpleOnGestureListener {
        C05924() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageSeventeen.this.mPopupWindow != null) {
                if (CollageSeventeen.this.mPopupWindow.isShowing()) {
                    CollageSeventeen.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageSeventeen.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageSeventeen.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageSeventeen$5 */
    class C05935 implements OnClickListener {
        C05935() {
        }

        public void onClick(View view) {
            CollageSeventeen.this.mPopupWindow.dismiss();
            CollageSeventeen.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageSeventeen$6 */
    class C05946 implements OnClickListener {
        C05946() {
        }

        public void onClick(View view) {
            CollageSeventeen.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageSeventeen.this.getStoredBitmap(CollageSeventeen.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageSeventeen.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageSeventeen.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageSeventeen$7 */
    ...
    public static CollageSeventeen newInstance(boolean b) {
        CollageSeventeen fragment = new CollageSeventeen();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_17, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageSeventeen.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageSeventeen$2$1 */
                class C05891 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageSeventeen.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageSeventeen.this.getActivity().runOnUiThread(new C05891());
                    }
                }
            });
    ...
    public void setGridPadding(int padding) {
        ...
        lp4.setMargins(this.curPadding / 2, this.curPadding / 2, this.curPadding, this.curPadding);
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C05924());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C05935());
        delete.setOnClickListener(new C05946());
        cancel.setOnClickListener(new C05957());
    }
