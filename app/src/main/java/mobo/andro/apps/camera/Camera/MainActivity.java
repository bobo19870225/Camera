...
public class MainActivity extends AppCompatActivity {
    ...
    public static Integer[] imageFilter2 = new Integer[]{Integer.valueOf(R.drawable.filter1), Integer.valueOf(R.drawable.filter2), Integer.valueOf(R.drawable.filter3), Integer.valueOf(R.drawable.filter4), Integer.valueOf(R.drawable.filter5), Integer.valueOf(R.drawable.filter6), Integer.valueOf(R.drawable.filter7), Integer.valueOf(R.drawable.filter8), Integer.valueOf(R.drawable.filter9), Integer.valueOf(R.drawable.filter10), Integer.valueOf(R.drawable.filter11), Integer.valueOf(R.drawable.filter12), Integer.valueOf(R.drawable.filter13), Integer.valueOf(R.drawable.filter14), Integer.valueOf(R.drawable.filter15), Integer.valueOf(R.drawable.filter16), Integer.valueOf(R.drawable.filter17), Integer.valueOf(R.drawable.filter18), Integer.valueOf(R.drawable.filter19), Integer.valueOf(R.drawable.filter20), Integer.valueOf(R.drawable.filter21), Integer.valueOf(R.drawable.filter22), Integer.valueOf(R.drawable.filter23), Integer.valueOf(R.drawable.filter24), Integer.valueOf(R.drawable.filter25), Integer.valueOf(R.drawable.filter26), Integer.valueOf(R.drawable.filter27), Integer.valueOf(R.drawable.filter28), Integer.valueOf(R.drawable.filter29), Integer.valueOf(R.drawable.filter30), Integer.valueOf(R.drawable.filter31), Integer.valueOf(R.drawable.filter32), Integer.valueOf(R.drawable.filter33), Integer.valueOf(R.drawable.filter34), Integer.valueOf(R.drawable.filter35), Integer.valueOf(R.drawable.filter36), Integer.valueOf(R.drawable.filter37), Integer.valueOf(R.drawable.filter38), Integer.valueOf(R.drawable.filter39), Integer.valueOf(R.drawable.filter40), Integer.valueOf(R.drawable.filter41), Integer.valueOf(R.drawable.filter42), Integer.valueOf(R.drawable.filter43), Integer.valueOf(R.drawable.filter44), Integer.valueOf(R.drawable.filter45), Integer.valueOf(R.drawable.filter46), Integer.valueOf(R.drawable.filter47), Integer.valueOf(R.drawable.filter48), Integer.valueOf(R.drawable.filter49), Integer.valueOf(R.drawable.filter50), Integer.valueOf(R.drawable.filter51), Integer.valueOf(R.drawable.filter52), Integer.valueOf(R.drawable.filter53), Integer.valueOf(R.drawable.filter54), Integer.valueOf(R.drawable.filter55), Integer.valueOf(R.drawable.filter56)};
    ...
    public static final String[] EFFECT_CONFIGS = new String[]
            {
                      "@adjust sharpen 5 1.5 @beautify face 1 480 640"
                    , "@adjust sharpen 4 1.5 @beautify face 1 600 900 @adjust lut lut37.png"
                    , "@adjust sharpen 5 1.5 @beautify face 1 600 900 @adjust lut lut1.png"
                    , "@adjust sharpen 5 1.5 @beautify face 1 600 900 @adjust lut lut2.png"
                    , "@adjust sharpen 5 1.5 @beautify face 1 600 900 @adjust lut lut3.png"
                    , "@adjust sharpen 5 1.5 @beautify face 1 600 900 @adjust lut lut4.png"
                    ...
                    , "@adjust sharpen 5 1.5 @beautify face 1 600 900 @adjust lut lut7.png"
                    , "@adjust sharpen 5 1.5 @beautify face 1 600 900 @adjust lut lut8.png"
                    , "@adjust sharpen 5 1.5 @beautify face 1 600 900 @curve R(0, 0)(71, 74)(164, 165)(255, 255) @pixblend screen 0.94118 0.29 0.29 1 20"
                    , "@adjust sharpen 5 1.5 @beautify face 1 600 900 @adjust lut lut10.png"
                    , "@adjust sharpen 5 1.5 @beautify face 1 600 900 @curve G(0, 0)(101, 127)(255, 255) @pixblend colordodge 0.937 0.482 0.835 1 20"
                    , "@adjust sharpen 5 1.5 @beautify face 1 600 900 @adjust lut lut11.png"
                    , "@adjust sharpen 5 1.5 @beautify face 1 600 900 @adjust lut lut13.png"
                    , "@adjust sharpen 5 1.5 @beautify face 1 600 900 @adjust lut lut14.png"
                    , "@adjust sharpen 5 1.5 @beautify face 1 600 900 @curve R(15, 0)(92, 133)(255, 234)G(0, 20)(105, 128)(255, 255)B(0, 0)(120, 132)(255, 214)"
                    ...
                    , "@adjust sharpen 5 1.5 @beautify face 1 600 900 @adjust lut lut17.png"
                    ...
                    , "@adjust sharpen 5 1.5 @beautify face 1 600 900 @adjust lut lut24.png"
                    ...
                    , "@beautify face 1 600 900 @adjust lut lut2.png #unpack @krblend sr b7.png 100"
    ...
    public static final String EFFECT_CONFIGS1[] = {
            "",
