...
public class CollageThirtyOne extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtyOne$3 */
    class C06713 implements Runnable {
        C06713() {
        }

        public void run() {
            CollageThirtyOne.this.setGridPadding(CollageThirtyOne.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtyOne$4 */
    class C06724 extends SimpleOnGestureListener {
        C06724() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageThirtyOne.this.mPopupWindow != null) {
                if (CollageThirtyOne.this.mPopupWindow.isShowing()) {
                    CollageThirtyOne.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageThirtyOne.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageThirtyOne.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtyOne$5 */
    class C06735 implements OnClickListener {
        ...
        public void onClick(View view) {
            CollageThirtyOne.this.mPopupWindow.dismiss();
            CollageThirtyOne.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtyOne$6 */
    class C06746 implements OnClickListener {
        C06746() {
        }

        public void onClick(View view) {
            CollageThirtyOne.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageThirtyOne.this.getStoredBitmap(CollageThirtyOne.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageThirtyOne.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageThirtyOne.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtyOne$7 */
    class C06757 implements OnClickListener {
        C06757() {
        }
    ...
    public static CollageThirtyOne newInstance(boolean b) {
        CollageThirtyOne fragment = new CollageThirtyOne();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_31, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageThirtyOne.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageThirtyOne$2$1 */
                class C06691 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageThirtyOne.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageThirtyOne.this.getActivity().runOnUiThread(new C06691());
                    }
                }
            });
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C06724());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C06735());
        delete.setOnClickListener(new C06746());
        cancel.setOnClickListener(new C06757());
    }
