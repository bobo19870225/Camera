...
public class CollageTwentyFive extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyFive$3 */
    class C07433 implements Runnable {
        C07433() {
        }

        public void run() {
            CollageTwentyFive.this.setGridPadding(CollageTwentyFive.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyFive$4 */
    class C07444 extends SimpleOnGestureListener {
        C07444() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageTwentyFive.this.mPopupWindow != null) {
                if (CollageTwentyFive.this.mPopupWindow.isShowing()) {
                    CollageTwentyFive.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageTwentyFive.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageTwentyFive.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyFive$5 */
    class C07455 implements OnClickListener {
        C07455() {
        }

        public void onClick(View view) {
            CollageTwentyFive.this.mPopupWindow.dismiss();
            CollageTwentyFive.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyFive$6 */
    class C07466 implements OnClickListener {
        C07466() {
        }

        public void onClick(View view) {
            CollageTwentyFive.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageTwentyFive.this.getStoredBitmap(CollageTwentyFive.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageTwentyFive.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageTwentyFive.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyFive$7 */
    class C07477 implements OnClickListener {
        C07477() {
        }
    ...
    public static CollageTwentyFive newInstance(boolean b) {
        CollageTwentyFive fragment = new CollageTwentyFive();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_25, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageTwentyFive.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageTwentyFive$2$1 */
                class C07411 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageTwentyFive.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageTwentyFive.this.getActivity().runOnUiThread(new C07411());
                    }
                }
            });
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C07444());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C07455());
        delete.setOnClickListener(new C07466());
        cancel.setOnClickListener(new C07477());
    }
