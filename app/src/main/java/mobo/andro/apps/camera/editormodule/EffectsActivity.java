...
import mobo.andro.apps.camera.editormodule.GPUImageFilterTools.FilterAdjuster;
...
public class EffectsActivity extends Activity {
    ...
    class ThumbnailLoader extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Bitmap createScaledBitmap = Bitmap.createScaledBitmap(EffectsActivity.this.bitmap, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
