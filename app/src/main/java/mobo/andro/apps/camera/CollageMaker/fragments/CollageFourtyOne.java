...
public class CollageFourtyOne extends Fragment implements CollageInterface, OnTouchListener, OnClickListener, TouchCallbackListener {
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyOne$3 */
    class C05193 implements Runnable {
        C05193() {
        }

        public void run() {
            CollageFourtyOne.this.setGridPadding(CollageFourtyOne.this.curPadding);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyOne$4 */
    class C05204 extends SimpleOnGestureListener {
        C05204() {
        }

        public boolean onDoubleTap(MotionEvent e) {
            if (CollageFourtyOne.this.mPopupWindow != null) {
                if (CollageFourtyOne.this.mPopupWindow.isShowing()) {
                    CollageFourtyOne.this.mPopupWindow.dismiss();
                }
                int rawX = (int) e.getRawX();
                int rawY = (int) e.getRawY();
                RelativeLayout main_rel = (RelativeLayout) CollageFourtyOne.this.view.findViewById(R.id.main_rel);
                int[] posXY = new int[2];
                main_rel.getLocationOnScreen(posXY);
                CollageFourtyOne.this.mPopupWindow.showAtLocation(main_rel, 51, rawX + posXY[0], rawY + posXY[1]);
            }
            return true;
        }
    ...
    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyOne$5 */
    class C05215 implements OnClickListener {
        C05215() {
        }

        public void onClick(View view) {
            CollageFourtyOne.this.mPopupWindow.dismiss();
            CollageFourtyOne.this.onGalleryButtonClick(FragmentsManager.REQUEST_GALLERY_ONDOUBLECLICK);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyOne$6 */
    class C05226 implements OnClickListener {
        ...
        public void onClick(View view) {
            CollageFourtyOne.this.mPopupWindow.dismiss();
            Bitmap bitmap = CollageFourtyOne.this.getStoredBitmap(CollageFourtyOne.this.focusedView);
            PhotoEditor.bitmap = bitmap.copy(bitmap.getConfig(), true);
            Intent intentEditor = new Intent(CollageFourtyOne.this.getActivity(), PhotoEditor.class);
            intentEditor.setAction("android.intent.action.MAIN");
            CollageFourtyOne.this.startActivityForResult(intentEditor, FragmentsManager.REQUEST_EDITOR);
        }
    }

    /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyOne$7 */
    class C05237 implements OnClickListener {
        C05237() {
        }
    ...
    public static CollageFourtyOne newInstance(boolean b) {
        CollageFourtyOne fragment = new CollageFourtyOne();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collage_41, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(new Runnable() {
            public void run() {
                CollageFourtyOne.this.optimizeLayout(view);
            }
        });
        initGd();
    ...
    private void createGLViewForImage(View view, final GLFilterImageView img, final Bitmap bitmap) {
        if (!this.forShowOffOnly) {
            ...
            mainImageView.setSurfaceCreatedCallback(new OnSurfaceCreatedCallback() {
                ...
                /* renamed from: mobo.andro.apps.camera.CollageMaker.fragments.CollageFourtyOne$2$1 */
                class C05171 implements Runnable {
                    ...
                    public void run() {
                        ...
                        img.setFilterConfig(CollageFourtyOne.this.img1.getmCurConfig());
                ...
                public void surfaceCreated() {
                    if (ImageGalleryActivity.selectedBitmaps.size() > 0) {
                        CollageFourtyOne.this.getActivity().runOnUiThread(new C05171());
                    }
                }
            });
    ...
    private void optimizeLayout(View view) {
        ...
        main_rel.invalidate();
        ImageUtils.optimizeView(this.rl1, 0.0f, 0.0f, Dimensions.S_5P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl2, (float) Dimensions.S_5P, 0.0f, Dimensions.S_5P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl3, (float) (Dimensions.S_5P * 2), 0.0f, Dimensions.S_5P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl4, (float) (Dimensions.S_5P * 3), 0.0f, Dimensions.S_5P, Dimensions.MATCH_PARENT);
        ImageUtils.optimizeView(this.rl5, (float) (Dimensions.S_5P * 4), 0.0f, Dimensions.S_5P, Dimensions.MATCH_PARENT);
        view.post(new C05193());
    }
    ...
    public void setGridPadding(int padding) {
        ...
        lp4.setMargins(this.curPadding / 2, this.curPadding, this.curPadding / 2, this.curPadding);
        ...
        this.div4.setX((this.rl4.getX() + ((float) this.rl4.getWidth())) - ((float) (this.curPadding / 2)));
    }
                ...
                if (view.getId() != R.id.div1 || (view.getX() - ((float) dx)) + ((float) view.getWidth()) > this.div2.getX() + ((float) this.div2.getWidth()) || view.getX() - ((float) dx) < 0.0f) {
                    if (view.getId() != R.id.div2 || (view.getX() - ((float) dx)) + ((float) view.getWidth()) > this.div3.getX() + ((float) this.div3.getWidth()) || view.getX() - ((float) dx) < this.div1.getX()) {
                        if (view.getId() != R.id.div3 || (view.getX() - ((float) dx)) + ((float) view.getWidth()) > this.div4.getX() + ((float) this.div4.getWidth()) || view.getX() - ((float) dx) < this.div2.getX()) {
                            if (view.getId() == R.id.div4 && (view.getX() - ((float) dx)) + ((float) view.getWidth()) <= this.rl5.getX() + ((float) this.rl5.getWidth()) && view.getX() - ((float) dx) >= this.div3.getX()) {
    ...
    private void initGd() {
        this.gdetector = new GestureDetector(getActivity(), new C05204());
    }
    ...
    private void initPopupWindow() {
        ...
        ((TextView) customView.findViewById(R.id.open)).setOnClickListener(new C05215());
        delete.setOnClickListener(new C05226());
        cancel.setOnClickListener(new C05237());
    }
